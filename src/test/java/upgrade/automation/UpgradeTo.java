...
public class UpgradeTo {
    ...
    public static void testUpgradeTo(String firmwareVersion, String cameraVersion) throws InterruptedException {
        LocatorHelper xpathHelper = new LocatorHelper(ConstPath.UpgradeToXpath + firmwareVersion + ".properties");
